...
const EVENT_LABELS: Record<string, string> = {
  ...
  restaurant_calling: "Calling",
  call_completed_success: "Call succeeded",
  restaurant_succeeded: "Call succeeded",
  call_completed_failure: "Call failed",
  restaurant_failed: "Call failed",
  call_no_answer: "No answer",
  restaurant_no_answer: "No answer",
...
const EVENT_COLORS: Record<string, string> = {
  ...
  restaurant_calling: "text-blue-600",
  call_completed_success: "text-green-600",
  restaurant_succeeded: "text-green-600",
  call_completed_failure: "text-red-500",
  restaurant_failed: "text-red-500",
  call_no_answer: "text-yellow-600",
  restaurant_no_answer: "text-yellow-600",
